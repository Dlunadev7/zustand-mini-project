...
export const WeddingInvitationPage = () => {
  ...
  const guestCounter = useWeddingStore((state) => state.guestCounter); 
  const setGuestCounter = useWeddingStore((state) => state.setGuestCounter); 
          ...
          <form>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                min="0"
                value={guestCounter}
                onChange={({target}) => setGuestCounter(target.value)}
